import { User, Skill, Experience, Project, Education, Certification } from '@prisma/client';
import { ICertifications, IEducation, IExperience, IProjects, ISkill } from '../interface/user.interface';
